namespace ExpressionTreeTests
{
    ...
    public class ExpressionParserTests
    {
        ...
        [TestCase("A1+B2-C3*D4/E5",
            new[]
            {
                "VarNode", "OpNodeAdd", "VarNode", "OpNodeSub", "VarNode", "OpNodeMul", "VarNode", "OpNodeDiv",
                "VarNode"
            })]
        [TestCase("(A1+B1)+C1",
        ...
        [TestCase("A1*(B1+C1)-(D1+(E1/F1))",
            new[]
            {
                "VarNode", "OpNodeMul", "OpNodeLeftBrace", "VarNode", "OpNodeAdd", "VarNode", "OpNodeRightBrace",
                "OpNodeSub", "OpNodeLeftBrace", "VarNode", "OpNodeAdd", "OpNodeLeftBrace", "VarNode", "OpNodeDiv",
                "VarNode", "OpNodeRightBrace", "OpNodeRightBrace"
            })]
        ...
        [TestCase("A1+B2-C3*D4/E5",
            new[]
            {
                "VarNode", "VarNode", "OpNodeAdd", "VarNode", "VarNode", "OpNodeMul", "VarNode", "OpNodeDiv",
                "OpNodeSub"
            })]
        [TestCase("(A1+B1)+C1",
        ...
        [TestCase("A1*(B1+C1)-(D1+(E1/F1))",
            new[]
            {
                "VarNode", "VarNode", "VarNode", "OpNodeAdd", "OpNodeMul", "VarNode", "VarNode", "VarNode", "OpNodeDiv",
                "OpNodeAdd", "OpNodeSub"
            })]
